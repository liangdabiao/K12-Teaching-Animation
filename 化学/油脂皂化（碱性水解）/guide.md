...
## 1. 需求
动画展示油脂在 NaOH 中加热皂化生成甘油与肥皂的过程。

## 2. 专业思考
油脂皂化。动画两态：左油脂+NaOH加热、右生成甘油+肥皂(高级脂肪酸钠)。强调皂化是酯的碱性水解(不可逆)、肥皂主要成分是高级脂肪酸钠、钾皂更软。联系酯类通性与日常生活。
...
<header class="topbar">
  ...
  <span class="title">油脂皂化 · 碱性水解</span>
  <span class="subtitle">油脂+NaOH→肥皂</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>油脂</h4><div class="v">高级脂肪酸甘油酯</div></div><div class="card s3"><div class="num">2</div><h4>反应</h4><div class="v">+NaOH 加热</div></div><div class="card s4"><div class="num">3</div><h4>产物</h4><div class="v">甘油+肥皂</div></div><div class="card "><div class="num">4</div><h4>本质</h4><div class="v">酯的碱水解</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">油脂皂化 · 碱性水解</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察皂化</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "油脂结构", "body": "油脂是<strong>高级脂肪酸与甘油形成的酯</strong>，属于酯类。", "points": {"title": "结构", "items": ["<strong>甘油</strong>", "<strong>脂肪酸</strong>", "<strong>酯</strong>类", "<strong>不溶</strong>：水"]}}, {"tag": "皂化", "name": "皂化反应", "body": "油脂在<strong>NaOH 溶液中加热</strong>水解，生成<strong>甘油</strong>与<strong>高级脂肪酸钠(肥皂)</strong>。", "points": {"title": "皂化", "items": ["<strong>油脂</strong>+NaOH", "<strong>加热</strong>", "<strong>甘油</strong>", "<strong>肥皂</strong>：钠盐"]}, "code": "油脂 + 3NaOH → 甘油 + 3RCOONa"}, {"tag": "产物", "name": "产物用途", "body": "高级脂肪酸钠是<strong>肥皂</strong>主要成分；甘油用于化妆品等。", "points": {"title": "用途", "items": ["<strong>肥皂</strong>：钠盐", "<strong>甘油</strong>：保湿", "<strong>钾皂</strong>：软", "<strong>洗涤</strong>"]}}, {"tag": "本质", "name": "反应本质", "body": "皂化是<strong>酯的碱性水解</strong>，与酸催化水解相对。", "points": {"title": "本质", "items": ["<strong>碱水解</strong>", "<strong>不可逆</strong>", "<strong>对比</strong>：酸水解", "<strong>皂化值</strong>"]}}];
let stepIdx=0;
const SOAP={t:0};
function sceneInit(){SOAP.t=0;}
function sceneReset(){SOAP.t=0;}
function sceneUpdate(dt){SOAP.t+=dt*speed;if(SOAP.t>6)SOAP.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const s=Math.floor(SOAP.t/3)%2;
 drawText('油脂皂化：油脂 + NaOH → 甘油 + 高级脂肪酸钠(肥皂)',W/2,20,'#74b9ff',12);
 const cx=W/2,cy=H/2;
 if(s===0){ctx.fillStyle='#fbbf24';roundRect(cx-60,cy-15,120,30,6);ctx.fill();drawText('油脂(酯)',cx,cy,'#06281c',11);drawText('+ NaOH 加热',cx,cy-40,'#9ab0d0',11);}
 else {ctx.fillStyle='#34d399';ctx.beginPath();ctx.arc(cx-30,cy,18,0,7);ctx.fill();drawText('甘油',cx-30,cy+34,'#06281c',10);ctx.fillStyle='#38bdf8';ctx.beginPath();ctx.arc(cx+30,cy,18,0,7);ctx.fill();drawText('肥皂',cx+30,cy+34,'#fff',10);}
 drawText('皂化是酯的碱性水解，制肥皂与甘油',W/2,H-22,'#9ab0d0',11);}
