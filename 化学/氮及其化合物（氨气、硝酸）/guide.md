...
## 1. 需求
动画展示氮气、氨、硝酸三种含氮物质及其转化。

## 2. 专业思考
氮及化合物。动画三屏：N₂(三键稳定、占空气78%)、NH₃(刺激、弱碱、哈伯法合成)、HNO₃(强酸强氧化、不生成H₂)。强调人工固氮意义、硝酸的不稳定性与强氧化性(与金属反应放NO/NO₂而非H₂)。
...
<header class="topbar">
  ...
  <span class="title">氮及其化合物</span>
  <span class="subtitle">N₂→NH₃→HNO₃</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>氮气</h4><div class="v">N≡N 稳定</div></div><div class="card s3"><div class="num">2</div><h4>氨</h4><div class="v">NH₃ 刺激性</div></div><div class="card s4"><div class="num">3</div><h4>硝酸</h4><div class="v">强酸强氧化</div></div><div class="card "><div class="num">4</div><h4>路线</h4><div class="v">哈伯法</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">氮及其化合物</span></h2>
...
const STEPS=[{"tag": "基础", "name": "氮气 N₂", "body": "N₂ 含<strong>氮氮三键</strong>，键能大、性质稳定，占空气约 78%。", "points": {"title": "N₂", "items": ["<strong>N≡N</strong>：三键", "<strong>稳定</strong>", "<strong>占空</strong>：78%", "<strong>惰</strong>：常温"]}}, {"tag": "氨", "name": "氨 NH₃", "body": "NH₃ 有<strong>刺激性气味</strong>，易溶于水呈弱碱性，是重要化工原料。", "points": {"title": "NH₃", "items": ["<strong>刺激</strong>味", "<strong>溶于水</strong>：弱碱", "<strong>哈伯法</strong>", "<strong>化肥</strong>：原料"]}}, {"tag": "硝酸", "name": "硝酸 HNO₃", "body": "HNO₃ 是<strong>强酸、强氧化性</strong>，不稳定、易分解，与金属反应一般不生成 H₂。", "points": {"title": "HNO₃", "items": ["<strong>强酸</strong>", "<strong>强氧化</strong>", "<strong>不稳</strong>：分解", "<strong>不生成</strong>：H₂"]}}, {"tag": "路线", "name": "合成路线", "body": "工业：<strong>N₂ + 3H₂ ⇌ 2NH₃</strong>（哈伯法）→ 氧化制硝酸。", "points": {"title": "路线", "items": ["<strong>哈伯</strong>：合成氨", "<strong>氧化</strong>：制硝酸", "<strong>化肥</strong>：来源", "<strong>固氮</strong>：人工"]}}];
let stepIdx=0;
const NITR={t:0};
function sceneInit(){NITR.t=0;}
function sceneReset(){NITR.t=0;}
function sceneUpdate(dt){NITR.t+=dt*speed;if(NITR.t>6)NITR.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const s=Math.floor(NITR.t/2)%3;
 const names=['N₂：双键稳定，占空气78%','NH₃：刺激性，合成氨','HNO₃：强酸，硝酸'];
 drawText('氮及其化合物：'+names[s],W/2,22,'#74b9ff',13);
 const cx=W/2,cy=H/2;
 if(s===0){ctx.strokeStyle='#74b9ff';ctx.lineWidth=3;ctx.beginPath();ctx.moveTo(cx-20,cy);ctx.lineTo(cx+20,cy);ctx.stroke();drawText('N≡N',cx,cy-24,'#38bdf8',12);}
 else if(s===1){ctx.fillStyle='#34d399';ctx.beginPath();ctx.arc(cx,cy,24,0,7);ctx.fill();drawText('NH₃',cx,cy,'#06281c',12);drawText('NH₃+H₂O⇌NH₃·H₂O（弱碱）',cx,cy+50,'#9ab0d0',11);}
 else {ctx.fillStyle='#1e3a5f';roundRect(cx-40,cy-20,80,40,6);ctx.fill();ctx.strokeStyle='#74b9ff';ctx.stroke();drawText('HNO₃',cx,cy,'#fbbf24',12);drawText('不稳定、强氧化',cx,cy+50,'#9ab0d0',11);}
 drawText('N₂ → NH₃(哈伯法) → NO → HNO₃',W/2,H-22,'#9ab0d0',11);}
