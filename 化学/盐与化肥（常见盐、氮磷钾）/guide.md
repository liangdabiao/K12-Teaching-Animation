...
## 1. 需求
动画展示常见盐，并用植物生长演示氮磷钾化肥的作用。

## 2. 专业思考
盐与化肥是生产生活重点。动画上方列常见盐，下方植株随时间长高（施肥效果），标注 N/P/K 各自作用。强调合理施肥、防止水体富营养化；盐是酸碱中和产物，也是重要化工原料。
...
<header class="topbar">
  ...
  <span class="title">盐与化肥</span>
  <span class="subtitle">N促叶 P促根 K促茎</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>盐</h4><div class="v">金属离子+酸根</div></div><div class="card s3"><div class="num">2</div><h4>氮肥</h4><div class="v">促叶生长</div></div><div class="card s4"><div class="num">3</div><h4>磷钾</h4><div class="v">促根/茎</div></div><div class="card "><div class="num">4</div><h4>注意</h4><div class="v">防富营养化</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">盐与化肥</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察植物生长</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "盐的组成", "body": "<strong>盐</strong>由金属离子(或铵根)与酸根离子构成，如 NaCl、Na₂CO₃、CaCO₃。", "points": {"title": "组成", "items": ["<strong>金属离子</strong>", "<strong>酸根</strong>", "<strong>NaCl</strong>：食盐", "<strong>CaCO₃</strong>：石灰石"]}}, {"tag": "氮肥", "name": "氮肥 N", "body": "氮肥(含 N)促进<strong>叶</strong>生长，使叶色浓绿，如尿素、铵盐。", "points": {"title": "N", "items": ["<strong>促叶</strong>", "<strong>叶绿</strong>", "<strong>尿素</strong>", "<strong>过量</strong>：徒长"]}}, {"tag": "磷钾", "name": "磷肥钾肥", "body": "磷肥促<strong>根、花果</strong>发育；钾肥促<strong>茎秆健壮</strong>、抗倒伏。", "points": {"title": "P/K", "items": ["<strong>P</strong>：促根花果", "<strong>K</strong>：壮茎抗倒", "<strong>缺P</strong>：迟熟", "<strong>缺K</strong>：易倒"]}}, {"tag": "注意", "name": "合理施用", "body": "化肥过量会流入水体造成<strong>富营养化</strong>，应合理施用、提倡有机肥结合。", "points": {"title": "环境", "items": ["<strong>过量</strong>：污染", "<strong>富营养</strong>：水华", "<strong>合理</strong>：用量", "<strong>有机</strong>：结合"]}}];
let stepIdx=0;
const SALT={t:0};
function sceneInit(){SALT.t=0;}
function sceneReset(){SALT.t=0;}
function sceneUpdate(dt){SALT.t+=dt*speed;if(SALT.t>8)SALT.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 drawText('盐与化肥：常见盐 + N/P/K 化肥促生长',W/2,22,'#74b9ff',12);
 const salts=['NaCl食盐','Na₂CO₃纯碱','CaCO₃石灰石'];for(let i=0;i<3;i++){ctx.fillStyle='#1e3a5f';ctx.strokeStyle='#74b9ff';ctx.fillRect(W*0.12+i*30,90,26,26);ctx.strokeRect(W*0.12+i*30,90,26,26);drawText(salts[i],W*0.12+i*30-10,140,'#9ab0d0',11);}
 const g=Math.min(1,SALT.t/4);const px=W*0.7,py=H-70;ctx.strokeStyle='#34d399';ctx.lineWidth=4;ctx.beginPath();ctx.moveTo(px,py);ctx.lineTo(px,py-80*g);ctx.stroke();for(let i=0;i<3;i++){const ly=py-20-20*i*g;ctx.fillStyle='#34d399';ctx.beginPath();ctx.ellipse(px-16,ly,16,8,-0.6,0,7);ctx.fill();ctx.beginPath();ctx.ellipse(px+16,ly,16,8,0.6,0,7);ctx.fill();}
 drawText('N 促叶 · P 促根 · K 促茎',px,py+24,'#9ab0d0',12);
 drawText('化肥过量→水体富营养化（需合理施用）',W/2,H-22,'#9ab0d0',11);}
