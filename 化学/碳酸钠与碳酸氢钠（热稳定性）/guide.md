...
## 1. 需求
动画对比碳酸钠与碳酸氢钠的热稳定性及与酸反应速率。

## 2. 专业思考
碳酸盐对比。动画两态：Na₂CO₃(受热稳定、与酸较慢) vs NaHCO₃(受热分解放CO₂、与酸更快产气多)。强调用加热是否产生CO₂鉴别两者、小苏打用于烘焙膨松与泡沫灭火器、纯碱用于制玻璃。
...
<header class="topbar">
  ...
  <span class="title">碳酸钠 vs 碳酸氢钠</span>
  <span class="subtitle">Na₂CO₃ / NaHCO₃</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>纯碱</h4><div class="v">Na₂CO₃ 稳定</div></div><div class="card s3"><div class="num">2</div><h4>小苏打</h4><div class="v">NaHCO₃ 分解</div></div><div class="card s4"><div class="num">3</div><h4>与酸</h4><div class="v">NaHCO₃ 更快</div></div><div class="card "><div class="num">4</div><h4>应用</h4><div class="v">烘焙/灭火</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">碳酸钠 vs 碳酸氢钠</span></h2>
...
const STEPS=[{"tag": "基础", "name": "两者关系", "body": "<strong>碳酸钠 Na₂CO₃</strong>(纯碱/苏打)与<strong>碳酸氢钠 NaHCO₃</strong>(小苏打)都是钠盐，但性质有异。", "points": {"title": "对比", "items": ["<strong>Na₂CO₃</strong>：纯碱", "<strong>NaHCO₃</strong>：小苏打", "<strong>同</strong>：钠盐", "<strong>异</strong>：稳定"]}}, {"tag": "热稳", "name": "热稳定性", "body": "Na₂CO₃ <strong>受热稳定</strong>；NaHCO₃ <strong>受热易分解</strong>：2NaHCO₃ → Na₂CO₃ + CO₂↑ + H₂O。", "points": {"title": "热", "items": ["<strong>Na₂CO₃</strong>：不分解", "<strong>NaHCO₃</strong>：分解", "<strong>产物</strong>：CO₂", "<strong>鉴别</strong>：加热"]}, "code": "2NaHCO3 → Na2CO3 + CO2↑ + H2O"}, {"tag": "与酸", "name": "与酸反应", "body": "二者都能与酸反应放出 CO₂，但 <strong>NaHCO₃ 反应更快、产气更多</strong>。", "points": {"title": "与酸", "items": ["<strong>都放</strong>：CO₂", "<strong>NaHCO₃</strong>：更快", "<strong>小苏打</strong>：剧烈", "<strong>纯碱</strong>：较慢"]}}, {"tag": "应用", "name": "应用", "body": "小苏打用于<strong>烘焙膨松、灭火器</strong>；纯碱用于制玻璃、造纸、去油污。", "points": {"title": "用途", "items": ["<strong>烘焙</strong>：膨松", "<strong>灭火</strong>：CO₂", "<strong>玻璃</strong>：纯碱", "<strong>去油</strong>：碱"]}}];
let stepIdx=0;
const SODA={t:0};
function sceneInit(){SODA.t=0;}
function sceneReset(){SODA.t=0;}
function sceneUpdate(dt){SODA.t+=dt*speed;if(SODA.t>8)SODA.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const s=Math.floor(SODA.t/4)%2;
 drawText('Na₂CO₃(纯碱/苏打) vs NaHCO₃(小苏打)',W/2,20,'#74b9ff',13);
 const cx=W/2,cy=H/2-10;
 ctx.fillStyle=s?'#34d399':'#1e3a5f';roundRect(cx-50,cy-20,100,40,6);ctx.fill();ctx.strokeStyle='#74b9ff';ctx.stroke();
 drawText(s?'NaHCO₃':'Na₂CO₃',cx,cy,'#fbbf24',12);
 if(s){drawText('与酸：快、产气多',cx,cy-50,'#34d399',12);drawText('受热：2NaHCO₃→Na₂CO₃+CO₂↑+H₂O（分解）',cx,cy+50,'#9ab0d0',11);}
 else{drawText('与酸：较慢、产气少',cx,cy-50,'#9ab0d0',12);drawText('受热：稳定，不分解',cx,cy+50,'#9ab0d0',11);}
 drawText('小苏打常用于烘焙、灭火；纯碱用于制玻璃',W/2,H-22,'#9ab0d0',11);}
