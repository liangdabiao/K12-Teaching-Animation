...
## 1. 需求
动画展示三种金属电化学防护方法：涂覆、牺牲阳极、外加电流。

## 2. 专业思考
金属防护（区别于已有的铁生锈微观）。动画三态：涂覆隔绝、牺牲阳极(Zn保护Fe)、外加电流(接负极阴极)。强调腐蚀本质是失电子氧化，三类方法分别通过隔绝、牺牲更活泼金属、强制阴极来阻断氧化。
...
<header class="topbar">
  ...
  <span class="title">金属防护 · 电化学法</span>
  <span class="subtitle">涂覆/牺牲阳极/外加电流</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>涂覆</h4><div class="v">隔绝介质</div></div><div class="card s3"><div class="num">2</div><h4>牺牲阳极</h4><div class="v">Zn 保 Fe</div></div><div class="card s4"><div class="num">3</div><h4>外加电流</h4><div class="v">强制阴极</div></div><div class="card "><div class="num">4</div><h4>核心</h4><div class="v">阻止失电子</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">金属防护 · 电化学法</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察三种防护</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "腐蚀原理", "body": "金属腐蚀本质是<strong>失去电子被氧化</strong>（如铁成 Fe²⁺）。防护即阻止此过程。", "points": {"title": "本质", "items": ["<strong>失电子</strong>：氧化", "<strong>Fe→Fe²⁺</strong>", "<strong>环境</strong>：水/氧", "<strong>防护</strong>：阻断"]}}, {"tag": "涂覆", "name": "涂覆法", "body": "涂油漆、镀层、搪瓷等<strong>隔绝金属与介质</strong>，最常用。", "points": {"title": "涂覆", "items": ["<strong>油漆</strong>", "<strong>电镀</strong>", "<strong>搪瓷</strong>", "<strong>隔绝</strong>：介质"]}}, {"tag": "牺牲", "name": "牺牲阳极", "body": "在铁上接更活泼金属(如<strong>Zn</strong>)，Zn 先失电子被腐蚀，保护 Fe——牺牲阳极的阴极保护法。", "points": {"title": "牺牲", "items": ["<strong>Zn</strong>：更活泼", "<strong>先腐蚀</strong>", "<strong>保Fe</strong>", "<strong>船体</strong>：用"]}}, {"tag": "电流", "name": "外加电流", "body": "将被保护金属接电源<strong>负极(阴极)</strong>，强制其电子富余不被氧化。", "points": {"title": "外加", "items": ["<strong>接负极</strong>：阴极", "<strong>强制</strong>：不氧化", "<strong>管道</strong>：地下", "<strong>有效</strong>"]}}];
let stepIdx=0;
const PROT2={t:0};
function sceneInit(){PROT2.t=0;}
function sceneReset(){PROT2.t=0;}
function sceneUpdate(dt){PROT2.t+=dt*speed;if(PROT2.t>9)PROT2.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const r=Math.floor(PROT2.t/3)%3;
 const names=['① 涂覆：油漆/镀层隔绝','② 牺牲阳极：Zn 块保护 Fe','③ 外加电流：强制阴极'];
 drawText('金属防护：'+names[r],W/2,22,'#74b9ff',13);
 const bx=W/2-70,by=H-90,bw=140,bh=90;
 if(r===0){ctx.fillStyle='#34d399';ctx.fillRect(bx,by-bh,bw,8);ctx.strokeStyle='#74b9ff';ctx.strokeRect(bx,by-bh,bw,bh);}
 else if(r===1){ctx.strokeStyle='#74b9ff';ctx.strokeRect(bx,by-bh,bw,bh);ctx.fillStyle='#fbbf24';ctx.fillRect(bx-30,by-60,20,60);drawText('Zn',bx-20,by-30,'#06281c',10);}
 else {ctx.strokeStyle='#74b9ff';ctx.strokeRect(bx,by-bh,bw,bh);ctx.strokeStyle='#38bdf8';ctx.lineWidth=2;ctx.beginPath();ctx.moveTo(bx+bw+20,by-50);ctx.lineTo(bx+bw,by-50);ctx.stroke();drawText('−',bx+bw+30,by-50,'#38bdf8',12);}
 drawText('防腐核心：阻止 Fe 失电子被氧化',W/2,H-22,'#9ab0d0',12);}
