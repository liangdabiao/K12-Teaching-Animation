...
## 1. 需求
动画展示二氧化硅、硅酸盐产品、半导体硅三种硅材料。

## 2. 专业思考
硅及化合物。动画三屏：SiO₂原子晶体(石英/光纤)、硅酸盐(玻璃水泥陶瓷)、单质硅半导体(芯片)。强调硅地壳含量第二、SiO₂原子晶体稳定、半导体性质使硅成为信息时代基石。
...
<header class="topbar">
  ...
  <span class="title">硅及其化合物</span>
  <span class="subtitle">SiO₂ / 硅酸盐 / 半导体</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>SiO2</h4><div class="v">原子晶体</div></div><div class="card s3"><div class="num">2</div><h4>硅酸盐</h4><div class="v">玻璃水泥陶瓷</div></div><div class="card s4"><div class="num">3</div><h4>硅</h4><div class="v">半导体芯片</div></div><div class="card "><div class="num">4</div><h4>地位</h4><div class="v">信息基石</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">硅及其化合物</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放切换物质</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "硅的地位", "body": "硅是地壳中<strong>含量第二</strong>的元素，是信息技术时代的基石材料。", "points": {"title": "地位", "items": ["<strong>地壳</strong>：第二多", "<strong>半导体</strong>", "<strong>芯片</strong>：基石", "<strong>广泛</strong>：存在"]}}, {"tag": "SiO2", "name": "二氧化硅", "body": "SiO₂ 为<strong>原子晶体</strong>（石英、水晶），性质稳定；光导纤维主要成分。", "points": {"title": "SiO₂", "items": ["<strong>原子晶</strong>体", "<strong>石英</strong>水晶", "<strong>光纤</strong>：成分", "<strong>不溶</strong>：水"]}}, {"tag": "硅酸盐", "name": "硅酸盐", "body": "硅酸盐产品有<strong>玻璃、水泥、陶瓷</strong>等，传统无机非金属材料。", "points": {"title": "产品", "items": ["<strong>玻璃</strong>", "<strong>水泥</strong>", "<strong>陶瓷</strong>", "<strong>传统</strong>材"]}}, {"tag": "半导体", "name": "半导体硅", "body": "高纯单质硅是<strong>半导体</strong>，用于制造集成电路、芯片。", "points": {"title": "硅", "items": ["<strong>单晶</strong>硅", "<strong>半导体</strong>", "<strong>集成电路</strong>", "<strong>光伏</strong>：电池"]}}];
let stepIdx=0;
const SILI={t:0};
function sceneInit(){SILI.t=0;}
function sceneReset(){SILI.t=0;}
function sceneUpdate(dt){SILI.t+=dt*speed;if(SILI.t>6)SILI.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const s=Math.floor(SILI.t/2)%3;
 const names=['SiO₂：原子晶体(石英/光纤)','硅酸盐：玻璃、水泥、陶瓷','Si 半导体：芯片基石'];
 drawText('硅及其化合物：'+names[s],W/2,20,'#74b9ff',12);
 const cx=W/2,cy=H/2;
 if(s===0){for(let i=0;i<3;i++)for(let j=0;j<3;j++){const x=cx-30+i*30,y=cy-30+j*30;ctx.fillStyle='#cbd5e1';ctx.beginPath();ctx.arc(x,y,8,0,7);ctx.fill();}drawText('Si–O 四面体网络',cx,cy+50,'#9ab0d0',11);}
 else if(s===1){ctx.fillStyle='#9ab0d0';roundRect(cx-50,cy-20,100,40,6);ctx.fill();drawText('玻璃/水泥',cx,cy,'#0a1628',11);drawText('硅酸盐产品',cx,cy+50,'#9ab0d0',11);}
 else {ctx.fillStyle='#34d399';ctx.fillRect(cx-30,cy-30,60,60);drawText('Si 晶片',cx,cy,'#06281c',12);drawText('半导体→集成电路',cx,cy+50,'#9ab0d0',11);}
 drawText('硅是地壳含量第二的元素，信息时代基石',W/2,H-22,'#9ab0d0',11);}
