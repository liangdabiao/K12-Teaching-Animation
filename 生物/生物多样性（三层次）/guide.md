...
## 1. 需求
动画展示生物多样性的三个层次：遗传、物种、生态系统。

## 2. 专业思考
生物多样性三层次。动画三屏：遗传多样性(同种内基因差异、育种原材料)、物种多样性(丰富度)、生态系统多样性(森林/湿地等生境)。强调保护生物多样性即是保护基因库与生态安全、维系人类生存基础。
...
<header class="topbar">
  ...
  <span class="title">生物多样性</span>
  <span class="subtitle">遗传/物种/生态系统</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>遗传</h4><div class="v">基因多样性</div></div><div class="card s3"><div class="num">2</div><h4>物种</h4><div class="v">物种丰富度</div></div><div class="card s4"><div class="num">3</div><h4>生态</h4><div class="v">生境多样性</div></div><div class="card "><div class="num">4</div><h4>价值</h4><div class="v">资源与稳定</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">生物多样性</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放切换三层次</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "三层次", "body": "生物多样性包括<strong>遗传多样性、物种多样性、生态系统多样性</strong>三个层次。", "points": {"title": "层次", "items": ["<strong>遗传</strong>", "<strong>物种</strong>", "<strong>生态</strong>系统", "<strong>三</strong>层次"]}}, {"tag": "遗传", "name": "遗传多样性", "body": "遗传多样性指<strong>同种内不同个体的基因差异</strong>，是进化的原材料。", "points": {"title": "遗传", "items": ["<strong>种内</strong>差异", "<strong>基因</strong>库", "<strong>育种</strong>：源", "<strong>进化</strong>：材"]}}, {"tag": "物种", "name": "物种多样性", "body": "物种多样性指<strong>物种的丰富程度与均匀度</strong>。", "points": {"title": "物种", "items": ["<strong>丰富度</strong>", "<strong>均匀度</strong>", "<strong>指数</strong>：测", "<strong>基础</strong>"]}}, {"tag": "生态", "name": "生态系统多样性", "body": "生态系统多样性指<strong>生物群落与无机环境的多样类型</strong>(森林、湿地等)。", "points": {"title": "生态", "items": ["<strong>群落</strong>类型", "<strong>生境</strong>", "<strong>森林</strong>湿地", "<strong>服务</strong>"]}}];
let stepIdx=0;
const BIO2={t:0};
function sceneInit(){BIO2.t=0;}
function sceneReset(){BIO2.t=0;}
function sceneUpdate(dt){BIO2.t+=dt*speed;if(BIO2.t>6)BIO2.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const s=Math.floor(BIO2.t/2)%3;
 const names=['遗传多样性：同种内基因差异','物种多样性：物种丰富度','生态系统多样性：生境类型'];
 drawText('生物多样性三层次：'+names[s],W/2,20,'#74b9ff',12);
 const cx=W/2,cy=H/2;
 if(s===0){for(let i=0;i<5;i++){ctx.fillStyle=['#34d399','#38bdf8','#fbbf24','#f87171','#a855f7'][i];ctx.beginPath();ctx.arc(cx-60+i*30,cy,14,0,7);ctx.fill();}}
 else if(s===1){for(let i=0;i<6;i++){const x=cx-90+i*32;ctx.fillStyle='#34d399';ctx.beginPath();ctx.arc(x,cy-10,10,0,7);ctx.fill();ctx.strokeStyle='#1e3a5f';ctx.beginPath();ctx.moveTo(x,cy);ctx.lineTo(x,cy+24);ctx.stroke();}}
 else {ctx.fillStyle='#1e3a5f';roundRect(cx-70,cy-30,50,60,6);ctx.fill();ctx.fillStyle='#34d399';roundRect(cx+20,cy-30,50,60,6);ctx.fill();drawText('森林/湿地',cx,cy+50,'#9ab0d0',11);}
 drawText('保护生物多样性=保护基因库与生态安全',W/2,H-22,'#9ab0d0',11);}
