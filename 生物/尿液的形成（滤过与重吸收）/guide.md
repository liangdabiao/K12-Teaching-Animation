...
## 1. 需求
动画展示肾单位中肾小球滤过与肾小管重吸收形成尿液的过程。

## 2. 专业思考
尿液形成。动画两态：滤过(肾小球毛细血管→肾小囊原尿，血细胞/蛋白留血、水糖盐尿素滤出)、重吸收(小管回收葡萄糖/水/盐，余为尿)。强调肾单位是基本单位、重吸收使有用物质回血、终尿排废物维持稳态。
...
<header class="topbar">
  ...
  <span class="title">尿液的形成</span>
  <span class="subtitle">肾小球滤过 + 肾小管重吸收</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>滤过</h4><div class="v">肾小球→原尿</div></div><div class="card s3"><div class="num">2</div><h4>重吸收</h4><div class="v">回收有用物质</div></div><div class="card s4"><div class="num">3</div><h4>分泌</h4><div class="v">排出废物</div></div><div class="card "><div class="num">4</div><h4>单位</h4><div class="v">肾单位</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">尿液的形成</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察肾单位工作</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "肾单位", "body": "<strong>肾单位</strong>是肾脏结构和功能的基本单位，包括肾小体和肾小管。", "points": {"title": "结构", "items": ["<strong>肾小球</strong>", "<strong>肾小囊</strong>", "<strong>肾小管</strong>", "<strong>基本</strong>单位"]}}, {"tag": "滤过", "name": "滤过作用", "body": "血液流经<strong>肾小球</strong>时，除血细胞和大分子蛋白外，水、葡萄糖、盐、尿素等滤入肾小囊形成<strong>原尿</strong>。", "points": {"title": "滤过", "items": ["<strong>肾小球</strong>", "<strong>血细胞</strong>留血", "<strong>水糖盐</strong>滤出", "<strong>原尿</strong>"]}}, {"tag": "重吸收", "name": "重吸收", "body": "原尿流经<strong>肾小管</strong>时，全部葡萄糖、大部分水、部分无机盐被<strong>重吸收</strong>回血液。", "points": {"title": "重吸收", "items": ["<strong>葡萄糖</strong>：全吸", "<strong>水</strong>：大部", "<strong>盐</strong>：部分", "<strong>回血</strong>"]}}, {"tag": "终尿", "name": "终尿", "body": "剩余的水、无机盐、尿素等形成<strong>终尿</strong>排出，维持体内平衡。", "points": {"title": "终尿", "items": ["<strong>尿素</strong>", "<strong>多余</strong>水盐", "<strong>排出</strong>", "<strong>稳态</strong>"]}}];
let stepIdx=0;
const URINE={t:0};
function sceneInit(){URINE.t=0;}
function sceneReset(){URINE.t=0;}
function sceneUpdate(dt){URINE.t+=dt*speed;if(URINE.t>6)URINE.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const s=Math.floor(URINE.t/3)%2;
 drawText(s?'重吸收：小管回收葡萄糖/水/盐，余为尿':'滤过：肾小球毛细血管→肾小囊原尿',W/2,20,'#74b9ff',12);
 const cx=W/2,cy=H/2;
 ctx.fillStyle='#f87171';ctx.beginPath();ctx.arc(cx,cy,30,0,7);ctx.fill();ctx.strokeStyle='#74b9ff';ctx.stroke();
 ctx.strokeStyle='#34d399';ctx.lineWidth=2;ctx.beginPath();ctx.arc(cx,cy+50,40,Math.PI,Math.PI*2);ctx.stroke();
 if(s){ctx.fillStyle='#34d399';for(let i=0;i<5;i++){ctx.beginPath();ctx.arc(cx-40+i*20,cy+50,6,0,7);ctx.fill();}drawText('回收有用物质',cx,cy+110,'#34d399',11);}
 else{drawText('血细胞/蛋白留血中，水/糖/盐/尿素滤出',cx,cy+110,'#9ab0d0',11);}
 drawText('肾单位：滤过→重吸收→分泌→终尿',W/2,H-22,'#9ab0d0',11);}
