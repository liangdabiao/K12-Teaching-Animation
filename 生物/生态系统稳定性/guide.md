...
## 1. 需求
动画对比生态系统抵抗力稳定性(复杂)与恢复力稳定性(简单)。

## 2. 专业思考
生态系统稳定性。动画两态：复杂食物网(抵抗力强、抗干扰) vs 简单结构(恢复快、但抵抗力弱)。强调抵抗力与恢复力常呈权衡、生物多样性是稳定性基础、保护多样性即保生态安全。
...
<header class="topbar">
  ...
  <span class="title">生态系统稳定性</span>
  <span class="subtitle">抵抗力 vs 恢复力</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>抵抗力</h4><div class="v">抗干扰保持原状</div></div><div class="card s3"><div class="num">2</div><h4>恢复力</h4><div class="v">受扰后恢复</div></div><div class="card s4"><div class="num">3</div><h4>关系</h4><div class="v">常呈权衡</div></div><div class="card "><div class="num">4</div><h4>基础</h4><div class="v">生物多样性</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">生态系统稳定性</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察两类稳定</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "两种稳定性", "body": "生态系统稳定性含<strong>抵抗力稳定性</strong>(抗干扰)与<strong>恢复力稳定性</strong>(受扰后恢复)。", "points": {"title": "两类", "items": ["<strong>抵抗力</strong>：抗扰", "<strong>恢复力</strong>：复原", "<strong>不同</strong>", "<strong>统称</strong>：稳定"]}}, {"tag": "抵抗力", "name": "抵抗力稳定性", "body": "结构<strong>越复杂(物种多)</strong>，抵抗力越强，受干扰后保持原状能力越强。", "points": {"title": "抵抗力", "items": ["<strong>复杂</strong>：强", "<strong>物种多</strong>", "<strong>食物网</strong>", "<strong>抗扰</strong>"]}}, {"tag": "恢复力", "name": "恢复力稳定性", "body": "结构简单的系统受破坏后<strong>恢复较快</strong>，但抵抗力往往较弱，二者常权衡。", "points": {"title": "恢复力", "items": ["<strong>简单</strong>：恢复快", "<strong>弱抵抗</strong>", "<strong>权衡</strong>", "<strong>北极</strong>：例"]}}, {"tag": "基础", "name": "基础", "body": "<strong>生物多样性</strong>是稳定性的基础；保护多样性即增强生态安全。", "points": {"title": "基础", "items": ["<strong>多样性</strong>↑", "<strong>稳定</strong>↑", "<strong>保护</strong>", "<strong>安全</strong>"]}}];
let stepIdx=0;
const ECO={t:0};
function sceneInit(){ECO.t=0;}
function sceneReset(){ECO.t=0;}
function sceneUpdate(dt){ECO.t+=dt*speed;if(ECO.t>8)ECO.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const r=Math.floor(ECO.t/4)%2;
 drawText(r?'恢复力稳定性：结构简单，受扰后恢复快':'抵抗力稳定性：结构复杂，抗干扰强',W/2,20,'#74b9ff',12);
 const cx=W/2,cy=H/2;
 const n=r?3:7;const step=n>1?160/(n-1):0;
 for(let i=0;i<n;i++){const x=cx-80+i*step;ctx.fillStyle=i%2?'#34d399':'#1e3a5f';ctx.beginPath();ctx.arc(x,cy,16,0,7);ctx.fill();ctx.strokeStyle='#74b9ff';ctx.stroke();if(i<n-1){ctx.strokeStyle='#9ab0d0';ctx.beginPath();ctx.moveTo(x,cy);ctx.lineTo(cx-80+(i+1)*step,cy);ctx.stroke();}}
 drawText('生物多样性越高→抵抗力越强；恢复力二者常权衡',W/2,H-22,'#9ab0d0',11);}
