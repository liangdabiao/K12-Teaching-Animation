...
## 1. 需求
动画对比细胞凋亡(有序、无炎症)与坏死(失控、引发炎症)。

## 2. 专业思考
细胞死亡的两种形式。动画左凋亡(皱缩出芽、被吞噬、无炎症)、右坏死(肿胀破裂、内容物外泄、炎症)。强调凋亡是基因控制的程序性死亡(发育指间、免疫细胞清除、抗衰老)，坏死多为意外病理损伤。
...
<header class="topbar">
  ...
  <span class="title">细胞凋亡 vs 坏死</span>
  <span class="subtitle">程序性死亡 vs 意外</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>凋亡</h4><div class="v">程序性有序</div></div><div class="card s3"><div class="num">2</div><h4>特征</h4><div class="v">皱缩出芽</div></div><div class="card s4"><div class="num">3</div><h4>坏死</h4><div class="v">意外失控</div></div><div class="card "><div class="num">4</div><h4>后果</h4><div class="v">无炎 vs 炎症</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">细胞凋亡 vs 坏死</span></h2>
...
const STEPS=[{"tag": "基础", "name": "两种细胞死亡", "body": "细胞死亡主要有<strong>细胞凋亡(程序性)</strong>与<strong>细胞坏死(意外)</strong>两类，机制与后果不同。", "points": {"title": "两类", "items": ["<strong>凋亡</strong>：程序性", "<strong>坏死</strong>：意外", "<strong>主动</strong>vs<strong>被动</strong>", "<strong>生理</strong>vs<strong>病理</strong>"]}}, {"tag": "凋亡", "name": "细胞凋亡", "body": "凋亡是<strong>基因控制的主动、有序</strong>死亡：细胞皱缩、出芽，被吞噬，<strong>不引起炎症</strong>。", "points": {"title": "凋亡", "items": ["<strong>基因</strong>控制", "<strong>皱缩</strong>出芽", "<strong>吞噬</strong>", "<strong>无炎</strong>症"]}}, {"tag": "坏死", "name": "细胞坏死", "body": "坏死由<strong>缺氧、中毒等意外</strong>引起：细胞肿胀、破裂，内容物外泄，<strong>引发炎症</strong>。", "points": {"title": "坏死", "items": ["<strong>意外</strong>损伤", "<strong>肿胀</strong>破裂", "<strong>外泄</strong>", "<strong>炎症</strong>"]}}, {"tag": "意义", "name": "生理意义", "body": "凋亡对发育、免疫、清除衰老细胞至关重要；坏死多为病理性损伤。", "points": {"title": "意义", "items": ["<strong>发育</strong>：指间", "<strong>免疫</strong>：清靶", "<strong>衰老</strong>：清除", "<strong>坏死</strong>：病"]}}];
let stepIdx=0;
const APOP={t:0};
function sceneInit(){APOP.t=0;}
function sceneReset(){APOP.t=0;}
function sceneUpdate(dt){APOP.t+=dt*speed;if(APOP.t>6)APOP.t=0;}
function cell(x,y,r,c){ctx.fillStyle=c;ctx.beginPath();ctx.arc(x,y,r,0,7);ctx.fill();ctx.strokeStyle='#74b9ff';ctx.lineWidth=2;ctx.stroke();}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 drawText('细胞凋亡(程序性,有序) vs 坏死(意外,失控)',W/2,20,'#74b9ff',12);
 const ph=(APOP.t%6)/6;
 cell(W*0.28,H/2,40,'#1e3a5f');ctx.fillStyle='#34d399';for(let i=0;i<6;i++){const a=i/6*7;ctx.beginPath();ctx.arc(W*0.28+Math.cos(a)*40,H/2+Math.sin(a)*40,6,0,7);ctx.fill();}
 drawText('凋亡：皱缩、出芽、被吞噬(无炎症)',W*0.28,H/2+70,'#34d399',11);
 const r2=40+10*Math.sin(ph*7);cell(W*0.72,H/2,r2,'#3a1e2a');ctx.fillStyle='#f87171';for(let i=0;i<5;i++){ctx.beginPath();ctx.arc(W*0.72+(i-2)*14,H/2+(i%2?10:-10),4,0,7);ctx.fill();}
 drawText('坏死：肿胀、破裂、内容物外泄(炎症)',W*0.72,H/2+70,'#f87171',11);}
