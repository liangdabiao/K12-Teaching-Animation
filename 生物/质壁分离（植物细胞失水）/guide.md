...
## 1. 需求
动画展示植物细胞在高渗/低渗环境下的质壁分离与复原过程。

## 2. 专业思考
质壁分离是渗透作用经典案例。动画用细胞壁（绿框）+ 内部液泡（蓝块，大小随含水量变化）表达：高渗时液泡缩小、与壁出现间隙（分离），低渗时复原。强调原生质层的选择透过性、必须活细胞才发生、死细胞不分离。应用：判断死活、测定细胞液浓度（刚发生分离的蔗糖浓度≈细胞液浓度）。
...
<header class="topbar">
  ...
  <span class="title">质壁分离 · 植物细胞失水</span>
  <span class="subtitle">外液浓度 > 细胞液</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>结构</h4><div class="v">细胞壁+原生质层+液泡</div></div><div class="card s3"><div class="num">2</div><h4>高渗</h4><div class="v">失水→质壁分离</div></div><div class="card s4"><div class="num">3</div><h4>低渗</h4><div class="v">吸水→复原</div></div><div class="card "><div class="num">4</div><h4>应用</h4><div class="v">观察/测定浓度</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">质壁分离 · 植物细胞失水</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察分离与复原</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "结构与原理", "body": "植物细胞有<strong>细胞壁</strong>和具选择透过性的<strong>原生质层</strong>（膜+层）。当外界溶液浓度 <strong>></strong> 细胞液时，细胞<strong>失水</strong>。", "points": {"title": "结构", "items": ["<strong>细胞壁</strong>：全透、刚性", "<strong>原生质层</strong>：选择透过", "<strong>液泡</strong>：贮水", "<strong>浓度差</strong>：驱动"]}, "code": "外液浓度 > 细胞液 → 失水"}, {"tag": "高渗", "name": "质壁分离", "body": "高渗环境下细胞失水，<strong>液泡缩小</strong>，原生质层收缩并与<strong>细胞壁分离</strong>，称质壁分离。", "points": {"title": "现象", "items": ["<strong>液泡</strong>：变小", "<strong>原生质层</strong>：收缩", "<strong>与壁分离</strong>：出现间隙", "<strong>宏观</strong>：质壁分离"]}}, {"tag": "低渗", "name": "复原", "body": "将细胞移入<strong>低渗（清水）</strong>环境，细胞吸水，原生质层恢复紧贴细胞壁，即<strong>质壁分离复原</strong>。", "points": {"title": "复原", "items": ["<strong>吸水</strong>：液泡膨大", "<strong>原生质层</strong>：回贴", "<strong>条件</strong>：活细胞", "<strong>死细胞</strong>：不发生"]}}, {"tag": "应用", "name": "应用", "body": "质壁分离实验可<strong>判断细胞死活</strong>、<strong>测定细胞液浓度</strong>、观察膜的选择透过性。", "points": {"title": "用途", "items": ["<strong>死活</strong>鉴定", "<strong>浓度</strong>测定", "<strong>膜透性</strong>演示", "<strong>选材</strong>：紫色洋葱"]}}];
let stepIdx=0;
const PLAS={t:0};
function sceneInit(){PLAS.t=0;}
function sceneReset(){PLAS.t=0;}
function sceneUpdate(dt){PLAS.t+=dt*speed;if(PLAS.t>8)PLAS.t=0;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const env=Math.floor(PLAS.t/4)%2;
 const s=Math.sin(PLAS.t/4*Math.PI);
 const shrink=env===1?s:(1-s);
 drawText('质壁分离：外界浓度 > 细胞液 → 失水分离；< 则复原',W/2,22,'#74b9ff',12);
 const cx=W/2,cy=H/2,wall=160;
 ctx.strokeStyle='#34d399';ctx.lineWidth=3;ctx.strokeRect(cx-wall/2,cy-wall/2,wall,wall);
 const v=wall*0.5*(0.35+0.65*shrink);
 ctx.fillStyle='#1e3a5f';ctx.strokeStyle='#74b9ff';ctx.lineWidth=2;roundRect(cx-v/2,cy-v/2,v,v,10);ctx.fill();ctx.stroke();
 drawText('液泡',cx,cy,'#fbbf24',12);
 drawText(env===1?'高渗：细胞失水，原生质层收缩与细胞壁分离':'低渗：细胞吸水，质壁分离复原',W/2,H-22,'#9ab0d0',12);}
