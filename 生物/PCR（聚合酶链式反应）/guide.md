...
## 1. 需求
动画展示 PCR 三个温度阶段（变性/退火/延伸）及指数扩增原理。

## 2. 专业思考
PCR 是分子生物学核心技术。动画用一条摆动双链：变性阶段双链振幅张开（解旋），退火阶段两端出现引物点，延伸阶段两链被“拉直”填满。强调三温度循环、Taq 酶耐热、每轮翻倍（2ⁿ），故少量模板可扩至可检测量。应用：新冠核酸检测、基因克隆、法医鉴定。
...
<header class="topbar">
  ...
  <span class="title">PCR · 扩增 DNA</span>
  <span class="subtitle">变性→退火→延伸</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>变性</h4><div class="v">95℃ 双链解开</div></div><div class="card s3"><div class="num">2</div><h4>退火</h4><div class="v">55℃ 引物结合</div></div><div class="card s4"><div class="num">3</div><h4>延伸</h4><div class="v">72℃ 聚合酶合成</div></div><div class="card "><div class="num">4</div><h4>指数</h4><div class="v">n 轮 → ×2ⁿ</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">PCR · 扩增 DNA</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察循环扩增</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "PCR 三步", "body": "<strong>PCR</strong> 体外扩增 DNA，每个循环三步：<strong>变性（95℃）</strong>双链解开、<strong>退火（55℃）</strong>引物结合、<strong>延伸（72℃）</strong>聚合酶合成新链。", "points": {"title": "温度", "items": ["<strong>95℃</strong>：变性解链", "<strong>55℃</strong>：退火", "<strong>72℃</strong>：延伸", "<strong>重复</strong>：指数扩增"]}, "code": "for(循环){ 变性; 退火; 延伸; }\n// 每轮 DNA 量翻倍"}, {"tag": "变性", "name": "① 变性", "body": "升温至 95℃，氢键断裂，<strong>双链 DNA 解旋</strong>为两条单链，作为模板。", "points": {"title": "要点", "items": ["<strong>温度</strong>：95℃", "<strong>键</strong>：氢键断", "<strong>产物</strong>：单链模板", "<strong>耐热酶</strong>：Taq"]}}, {"tag": "退火", "name": "② 退火", "body": "降温至约 55℃，<strong>引物</strong>与单链模板两端互补结合，为延伸提供起点。", "points": {"title": "要点", "items": ["<strong>温度</strong>：~55℃", "<strong>引物</strong>：短DNA", "<strong>结合</strong>：互补配对", "<strong>定向</strong>：定起点"]}}, {"tag": "延伸", "name": "③ 延伸", "body": "72℃ 下<strong>Taq 聚合酶</strong>从引物 3′端延伸，合成与模板互补的新链。一轮结束 DNA 量翻倍。", "points": {"title": "要点", "items": ["<strong>温度</strong>：72℃", "<strong>酶</strong>：Taq 耐热", "<strong>方向</strong>：5′→3′", "<strong>结果</strong>：×2"]}}, {"tag": "指数", "name": "指数扩增", "body": "每循环 DNA 量约翻倍，<strong>n 个循环后约为 2ⁿ 倍</strong>，故可快速获得大量目标片段。", "points": {"title": "数量", "items": ["<strong>1 轮</strong>：×2", "<strong>n 轮</strong>：×2ⁿ", "<strong>30 轮</strong>：≈10⁹", "<strong>用途</strong>：基因检测"]}}];
let stepIdx=0;
const PCR={t:0,cycle:0};
function sceneInit(){PCR.t=0;PCR.cycle=0;}
function sceneReset(){PCR.t=0;PCR.cycle=0;}
function sceneUpdate(dt){PCR.t+=dt*speed;if(PCR.t>3){PCR.t=0;PCR.cycle=(PCR.cycle+1)%3;}}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const steps=['① 变性 95℃：双链解开','② 退火 55℃：引物结合','③ 延伸 72℃：聚合酶合成'];
 drawText('PCR 聚合酶链式反应：'+steps[PCR.cycle],W/2,22,'#74b9ff',13);
 const cx=W/2,top=70,gap=38;
 const off=(PCR.cycle===0?PCR.t*3:0);
 ctx.strokeStyle='#74b9ff';ctx.lineWidth=3;
 ctx.beginPath();for(let i=0;i<=20;i++){const y=top+i*8;const x=cx+Math.sin(i/2+off)*gap;if(i===0)ctx.moveTo(x,y);else ctx.lineTo(x,y);}ctx.stroke();
 ctx.strokeStyle='#34d399';
 ctx.beginPath();for(let i=0;i<=20;i++){const y=top+i*8;const x=cx-Math.sin(i/2+off)*gap;if(i===0)ctx.moveTo(x,y);else ctx.lineTo(x,y);}ctx.stroke();
 if(PCR.cycle===1){ctx.fillStyle='#fbbf24';ctx.beginPath();ctx.arc(cx-gap,top+10,5,0,7);ctx.fill();ctx.beginPath();ctx.arc(cx+gap,top+10,5,0,7);ctx.fill();drawText('引物',cx-gap-18,top+10,'#fbbf24',11);}
 drawText('循环 n 次 → DNA 量 ×2ⁿ',W/2,H-26,'#9ab0d0',13);}
