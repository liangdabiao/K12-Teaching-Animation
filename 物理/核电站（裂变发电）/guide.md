...
## 1. 需求
动画展示核电站能量转换链：裂变→热→蒸汽→机械→电。

## 2. 专业思考
核电站能量链。动画四阶段循环：反应堆裂变放热→锅炉产蒸汽→汽轮机旋转→发电机发电。强调控制棒调节链式反应速率使之可控、能量经核→热→机械→电逐级转换；安全防护与废料处置是重点。
...
<header class="topbar">
  ...
  <span class="title">核电站 · 裂变发电</span>
  <span class="subtitle">可控链式裂变→电</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>反应</h4><div class="v">可控重核裂变</div></div><div class="card s3"><div class="num">2</div><h4>能量</h4><div class="v">热→蒸汽</div></div><div class="card s4"><div class="num">3</div><h4>转换</h4><div class="v">机械→电</div></div><div class="card "><div class="num">4</div><h4>安全</h4><div class="v">防泄漏</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">核电站 · 裂变发电</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放观察能量链</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "能量来源", "body": "核电站用<strong>可控重核裂变</strong>释放的热能，使水变为蒸汽推动汽轮机发电。", "points": {"title": "来源", "items": ["<strong>裂变</strong>：铀核", "<strong>可控</strong>：链式", "<strong>热</strong>：加热水", "<strong>蒸汽</strong>：推轮"]}}, {"tag": "反应堆", "name": "反应堆", "body": "反应堆内铀核裂变，由<strong>控制棒</strong>吸收中子调节反应速率，使其稳定可控。", "points": {"title": "控制", "items": ["<strong>控制棒</strong>：吸收中子", "<strong>慢化剂</strong>：减速", "<strong>链式</strong>：可控", "<strong>安全</strong>：第一"]}}, {"tag": "转换", "name": "能量转换", "body": "裂变热→水蒸气内能→汽轮机<strong>机械能</strong>→发电机<strong>电能</strong>。", "points": {"title": "链", "items": ["<strong>核→热</strong>", "<strong>热→机械</strong>", "<strong>机械→电</strong>", "<strong>清洁</strong>：少碳"]}}, {"tag": "安全", "name": "安全", "body": "多层防护与冷却系统防止放射性泄漏；废料需妥善处置。", "points": {"title": "防护", "items": ["<strong>压力容器</strong>", "<strong>安全壳</strong>", "<strong>冷却</strong>：必备", "<strong>废料</strong>：处置"]}}];
let stepIdx=0;
const NP={t:0,step:0};
function sceneInit(){NP.t=0;}
function sceneReset(){NP.t=0;}
function sceneUpdate(dt){NP.t+=dt*speed;if(NP.t>8)NP.t=0;NP.step=Math.floor(NP.t/2)%4;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 const names=['① 反应堆：重核裂变放热','② 锅炉：加热水→蒸汽','③ 汽轮机：蒸汽推叶轮','④ 发电机：机械→电'];
 drawText('核电站：'+names[NP.step],W/2,22,'#74b9ff',13);
 const cx=W/2,cy=H/2-10;
 ctx.fillStyle='#1e3a5f';ctx.strokeStyle='#74b9ff';ctx.lineWidth=2;roundRect(cx-40,cy-30,80,60,8);ctx.fill();ctx.stroke();drawText('能量链',cx,cy,'#fbbf24',11);
 const labels=['裂变','蒸汽','旋转','发电'];
 for(let i=0;i<4;i++){drawText(labels[i],cx-120+i*80,cy+60,i===NP.step?'#34d399':'#9ab0d0',12);}
 drawText('可控链式裂变 → 热 → 蒸汽 → 机械能 → 电能（清洁但需防泄漏）',W/2,H-22,'#9ab0d0',11);}
