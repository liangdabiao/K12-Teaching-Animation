...
## 1. 需求
动画对比横波（质点垂直传播，波峰波谷）与纵波（质点平行，疏密相间）。

## 2. 专业思考
机械波分类基础。动画上排质点上下振动形成横波（波峰/波谷），下排质点左右疏密形成纵波（疏部/密部）。强调区分看‘振动方向与传播方向的关系’；声波是纵波、光波是横波；机械波需介质。
...
<header class="topbar">
  ...
  <span class="title">横波与纵波</span>
  <span class="subtitle">振动方向 vs 传播方向</span>
</header>
<div class="cards"><div class="card s2"><div class="num">1</div><h4>横波</h4><div class="v">振动⊥传播</div></div><div class="card s3"><div class="num">2</div><h4>纵波</h4><div class="v">振动∥传播</div></div><div class="card s4"><div class="num">3</div><h4>横例</h4><div class="v">绳波/光波</div></div><div class="card "><div class="num">4</div><h4>纵例</h4><div class="v">声波/弹簧波</div></div></div>
<main>
  <div class="stage"><canvas id="cv"></canvas></div>
  <aside class="panel">
    <h2><span class="badge" id="stepBadge">基础</span><span id="stepTitle">横波与纵波</span></h2>
...
<div class="controls">
  ...
  <span id="status" class="status">点击播放对比两类波</span>
</div>
<script>
...
const STEPS=[{"tag": "基础", "name": "波的分类", "body": "按质点振动方向与波传播方向的关系，分为<strong>横波</strong>与<strong>纵波</strong>。", "points": {"title": "分类", "items": ["<strong>横波</strong>：垂直", "<strong>纵波</strong>：平行", "<strong>介质</strong>：机械波需介质", "<strong>传播</strong>：能量向前"]}}, {"tag": "横波", "name": "横波", "body": "横波质点振动方向<strong>垂直</strong>于传播方向，呈现波峰与波谷（如绳波、光波）。", "points": {"title": "特征", "items": ["<strong>振动⊥</strong>传播", "<strong>波峰</strong>波谷", "<strong>例</strong>：绳波", "<strong>光</strong>：横波"]}}, {"tag": "纵波", "name": "纵波", "body": "纵波质点振动方向<strong>平行</strong>于传播方向，呈现疏部与密部（如声波、弹簧波）。", "points": {"title": "特征", "items": ["<strong>振动∥</strong>传播", "<strong>疏部</strong>密部", "<strong>例</strong>：声波", "<strong>介质</strong>：必需"]}}, {"tag": "介质", "name": "传播条件", "body": "机械波（横/纵）都<strong>需要介质</strong>传播；电磁波可在真空传播。", "points": {"title": "条件", "items": ["<strong>机械波</strong>：需介质", "<strong>真空</strong>：不传声", "<strong>电磁</strong>：可真空", "<strong>速度</strong>：介质定"]}}];
let stepIdx=0;
const WL={t:0};
function sceneInit(){WL.t=0;}
function sceneReset(){WL.t=0;}
function sceneUpdate(dt){WL.t+=dt*speed;}
function sceneDraw(){const W=cv.width,H=cv.height;ctx.clearRect(0,0,W,H);
 drawText('横波：质点垂直传播方向 · 纵波：质点平行（疏密）',W/2,22,'#74b9ff',12);
 const n=12;
 for(let i=0;i<n;i++){const x=60+i*(W-120)/(n-1);const y=H*0.32-Math.sin(i*0.6-WL.t*3)*22;ctx.fillStyle='#34d399';ctx.beginPath();ctx.arc(x,y,4,0,7);ctx.fill();}
 ctx.strokeStyle='#34d399';ctx.setLineDash([4,4]);ctx.beginPath();ctx.moveTo(60,H*0.32);ctx.lineTo(W-60,H*0.32);ctx.stroke();ctx.setLineDash([]);
 drawText('横波：波峰/波谷，振动⊥传播',W/2,H*0.32+44,'#34d399',12);
 for(let i=0;i<n;i++){const sp=Math.sin(i*0.6-WL.t*3)*8;const x=60+i*(W-120)/(n-1)+sp;const y=H*0.68;ctx.fillStyle=i%2?'#fbbf24':'#1e3a5f';ctx.beginPath();ctx.arc(x,y,5,0,7);ctx.fill();ctx.strokeStyle='#74b9ff';ctx.lineWidth=1;ctx.stroke();}
 drawText('纵波：疏部/密部，振动∥传播（声波）',W/2,H*0.68+40,'#fbbf24',12);}
